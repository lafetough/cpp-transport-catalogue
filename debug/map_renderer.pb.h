...
PROTOBUF_NAMESPACE_OPEN
template<> ::serial::RenderSettings* Arena::CreateMaybeMessage<::serial::RenderSettings>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace serial {
...
class RenderSettings final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:serial.RenderSettings) */ {
 public:
  ...
  ::serial::Color* mutable_color_palette(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::serial::Color >*
      mutable_color_palette();
  private:
  const ::serial::Color& _internal_color_palette(int index) const;
  ::serial::Color* _internal_add_color_palette();
  public:
  const ::serial::Color& color_palette(int index) const;
  ::serial::Color* add_color_palette();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::serial::Color >&
      color_palette() const;
  ...
  const ::serial::Offset& bus_label_offset() const;
  PROTOBUF_MUST_USE_RESULT ::serial::Offset* release_bus_label_offset();
  ::serial::Offset* mutable_bus_label_offset();
  void set_allocated_bus_label_offset(::serial::Offset* bus_label_offset);
  private:
  const ::serial::Offset& _internal_bus_label_offset() const;
  ::serial::Offset* _internal_mutable_bus_label_offset();
  public:
  void unsafe_arena_set_allocated_bus_label_offset(
      ::serial::Offset* bus_label_offset);
  ::serial::Offset* unsafe_arena_release_bus_label_offset();
  ...
  const ::serial::Offset& stop_label_offset() const;
  PROTOBUF_MUST_USE_RESULT ::serial::Offset* release_stop_label_offset();
  ::serial::Offset* mutable_stop_label_offset();
  void set_allocated_stop_label_offset(::serial::Offset* stop_label_offset);
  private:
  const ::serial::Offset& _internal_stop_label_offset() const;
  ::serial::Offset* _internal_mutable_stop_label_offset();
  public:
  void unsafe_arena_set_allocated_stop_label_offset(
      ::serial::Offset* stop_label_offset);
  ::serial::Offset* unsafe_arena_release_stop_label_offset();
  ...
  const ::serial::Color& underlayer_color() const;
  PROTOBUF_MUST_USE_RESULT ::serial::Color* release_underlayer_color();
  ::serial::Color* mutable_underlayer_color();
  void set_allocated_underlayer_color(::serial::Color* underlayer_color);
  private:
  const ::serial::Color& _internal_underlayer_color() const;
  ::serial::Color* _internal_mutable_underlayer_color();
  public:
  void unsafe_arena_set_allocated_underlayer_color(
      ::serial::Color* underlayer_color);
  ::serial::Color* unsafe_arena_release_underlayer_color();
  ...
  // @@protoc_insertion_point(class_scope:serial.RenderSettings)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::serial::Color > color_palette_;
  ::serial::Offset* bus_label_offset_;
  ::serial::Offset* stop_label_offset_;
  ::serial::Color* underlayer_color_;
  double width_;
  double height_;
  double padding_;
  double line_width_;
...
inline double RenderSettings::width() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.width)
...
inline void RenderSettings::set_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.width)
}
...
inline double RenderSettings::height() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.height)
...
inline void RenderSettings::set_height(double value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.height)
}
...
inline double RenderSettings::padding() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.padding)
...
inline void RenderSettings::set_padding(double value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.padding)
}
...
inline double RenderSettings::line_width() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.line_width)
...
inline void RenderSettings::set_line_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.line_width)
}
...
inline double RenderSettings::stop_radius() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.stop_radius)
...
inline void RenderSettings::set_stop_radius(double value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.stop_radius)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RenderSettings::bus_label_font_size() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.bus_label_font_size)
...
inline void RenderSettings::set_bus_label_font_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.bus_label_font_size)
}
...
inline const ::serial::Offset& RenderSettings::_internal_bus_label_offset() const {
  const ::serial::Offset* p = bus_label_offset_;
  return p != nullptr ? *p : reinterpret_cast<const ::serial::Offset&>(
      ::serial::_Offset_default_instance_);
}
inline const ::serial::Offset& RenderSettings::bus_label_offset() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.bus_label_offset)
...
inline void RenderSettings::unsafe_arena_set_allocated_bus_label_offset(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:serial.RenderSettings.bus_label_offset)
}
inline ::serial::Offset* RenderSettings::release_bus_label_offset() {
  
  ::serial::Offset* temp = bus_label_offset_;
...
inline ::serial::Offset* RenderSettings::unsafe_arena_release_bus_label_offset() {
  // @@protoc_insertion_point(field_release:serial.RenderSettings.bus_label_offset)
  
  ::serial::Offset* temp = bus_label_offset_;
  bus_label_offset_ = nullptr;
  return temp;
}
inline ::serial::Offset* RenderSettings::_internal_mutable_bus_label_offset() {
  
  if (bus_label_offset_ == nullptr) {
    auto* p = CreateMaybeMessage<::serial::Offset>(GetArenaForAllocation());
    bus_label_offset_ = p;
  }
  return bus_label_offset_;
}
inline ::serial::Offset* RenderSettings::mutable_bus_label_offset() {
  ::serial::Offset* _msg = _internal_mutable_bus_label_offset();
  // @@protoc_insertion_point(field_mutable:serial.RenderSettings.bus_label_offset)
  return _msg;
}
inline void RenderSettings::set_allocated_bus_label_offset(::serial::Offset* bus_label_offset) {
  ...
  bus_label_offset_ = bus_label_offset;
  // @@protoc_insertion_point(field_set_allocated:serial.RenderSettings.bus_label_offset)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 RenderSettings::stop_label_font_size() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.stop_label_font_size)
...
inline void RenderSettings::set_stop_label_font_size(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.stop_label_font_size)
}
...
inline const ::serial::Offset& RenderSettings::_internal_stop_label_offset() const {
  const ::serial::Offset* p = stop_label_offset_;
  return p != nullptr ? *p : reinterpret_cast<const ::serial::Offset&>(
      ::serial::_Offset_default_instance_);
}
inline const ::serial::Offset& RenderSettings::stop_label_offset() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.stop_label_offset)
...
inline void RenderSettings::unsafe_arena_set_allocated_stop_label_offset(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:serial.RenderSettings.stop_label_offset)
}
inline ::serial::Offset* RenderSettings::release_stop_label_offset() {
  
  ::serial::Offset* temp = stop_label_offset_;
...
inline ::serial::Offset* RenderSettings::unsafe_arena_release_stop_label_offset() {
  // @@protoc_insertion_point(field_release:serial.RenderSettings.stop_label_offset)
  
  ::serial::Offset* temp = stop_label_offset_;
  stop_label_offset_ = nullptr;
  return temp;
}
inline ::serial::Offset* RenderSettings::_internal_mutable_stop_label_offset() {
...
inline ::serial::Offset* RenderSettings::mutable_stop_label_offset() {
  ::serial::Offset* _msg = _internal_mutable_stop_label_offset();
  // @@protoc_insertion_point(field_mutable:serial.RenderSettings.stop_label_offset)
  return _msg;
}
inline void RenderSettings::set_allocated_stop_label_offset(::serial::Offset* stop_label_offset) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(stop_label_offset_);
  }
  ...
  stop_label_offset_ = stop_label_offset;
  // @@protoc_insertion_point(field_set_allocated:serial.RenderSettings.stop_label_offset)
}
...
inline const ::serial::Color& RenderSettings::_internal_underlayer_color() const {
  const ::serial::Color* p = underlayer_color_;
  return p != nullptr ? *p : reinterpret_cast<const ::serial::Color&>(
      ::serial::_Color_default_instance_);
}
inline const ::serial::Color& RenderSettings::underlayer_color() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.underlayer_color)
...
inline void RenderSettings::unsafe_arena_set_allocated_underlayer_color(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:serial.RenderSettings.underlayer_color)
}
inline ::serial::Color* RenderSettings::release_underlayer_color() {
  
  ::serial::Color* temp = underlayer_color_;
...
inline ::serial::Color* RenderSettings::unsafe_arena_release_underlayer_color() {
  // @@protoc_insertion_point(field_release:serial.RenderSettings.underlayer_color)
  
  ::serial::Color* temp = underlayer_color_;
  underlayer_color_ = nullptr;
  return temp;
}
inline ::serial::Color* RenderSettings::_internal_mutable_underlayer_color() {
  
  if (underlayer_color_ == nullptr) {
    auto* p = CreateMaybeMessage<::serial::Color>(GetArenaForAllocation());
    underlayer_color_ = p;
  }
  return underlayer_color_;
}
inline ::serial::Color* RenderSettings::mutable_underlayer_color() {
  ::serial::Color* _msg = _internal_mutable_underlayer_color();
  // @@protoc_insertion_point(field_mutable:serial.RenderSettings.underlayer_color)
  return _msg;
}
inline void RenderSettings::set_allocated_underlayer_color(::serial::Color* underlayer_color) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete reinterpret_cast< ::PROTOBUF_NAMESPACE_ID::MessageLite*>(underlayer_color_);
  }
  ...
  underlayer_color_ = underlayer_color;
  // @@protoc_insertion_point(field_set_allocated:serial.RenderSettings.underlayer_color)
}
...
inline double RenderSettings::underlayer_width() const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.underlayer_width)
...
inline void RenderSettings::set_underlayer_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:serial.RenderSettings.underlayer_width)
}
...
inline ::serial::Color* RenderSettings::mutable_color_palette(int index) {
  // @@protoc_insertion_point(field_mutable:serial.RenderSettings.color_palette)
  return color_palette_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::serial::Color >*
RenderSettings::mutable_color_palette() {
  // @@protoc_insertion_point(field_mutable_list:serial.RenderSettings.color_palette)
  return &color_palette_;
}
inline const ::serial::Color& RenderSettings::_internal_color_palette(int index) const {
  return color_palette_.Get(index);
}
inline const ::serial::Color& RenderSettings::color_palette(int index) const {
  // @@protoc_insertion_point(field_get:serial.RenderSettings.color_palette)
  return _internal_color_palette(index);
}
inline ::serial::Color* RenderSettings::_internal_add_color_palette() {
  return color_palette_.Add();
}
inline ::serial::Color* RenderSettings::add_color_palette() {
  ::serial::Color* _add = _internal_add_color_palette();
  // @@protoc_insertion_point(field_add:serial.RenderSettings.color_palette)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::serial::Color >&
RenderSettings::color_palette() const {
  // @@protoc_insertion_point(field_list:serial.RenderSettings.color_palette)
  return color_palette_;
}
